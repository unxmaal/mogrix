...
set(CMAKE_CXX_COMPILER /opt/sgug-staging/usr/sgug/bin/irix-cxx-libcxx)
...
# For libc++: DON'T add -I mogrix-compat/generic to CXX — it conflicts with libc++ header
# names (string.h, stddef.h, wchar.h). The irix-cxx-libcxx wrapper handles this via -isystem.
set(CMAKE_CXX_FLAGS_INIT "-Wno-macro-redefined -Dalloca=__builtin_alloca -mxgot")
