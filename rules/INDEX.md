...
| BFD multi-GOT corruption | 30% function-call GOT entries point to data in large .so | switch to LLD for shared libs | cross/bin/irix-ld | BFD ld -Bsymbolic-functions + multi-GOT mixes code/data addresses in orphan GOT |
